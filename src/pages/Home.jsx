    ...
    <>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-5">
          ...
          >
            GymFocus transforma consistência em evolução real através de
            gamificação, streaks e progresso inteligente.
          </motion.p>
          ...
          >
            ...
            <div className="flex justify-between items-center flex-wrap gap-5">
              ...
              <div>
                ...
                <h2 className="text-5xl font-bold">08</h2>
              </div>

              <div>
                <p className="text-zinc-400">XP</p>

                <h2 className="text-5xl font-bold">1480</h2>
              </div>
            </div>
            ...
            {/* Weekly Consistency */}
            <div className="mt-10">
              <p className="text-zinc-400 mb-4">Weekly Consistency</p>
